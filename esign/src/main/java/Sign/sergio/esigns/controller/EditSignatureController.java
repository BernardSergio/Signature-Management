...
public class EditSignatureController extends GenericSignatureController {
	...
	public void onSubmit(ActionEvent actionEvent) {
		try {
			...
			SignatureRequest newSignatureRequest = SignatureRequestEService.getService().update(signatureRequest);
